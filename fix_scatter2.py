with open('runtime/debris_spawn.py', 'r') as f:
    content = f.read()

old = """floor = settings.ground_z + GROUND_CLEARANCE - low_off
...
new = """floor = settings.ground_z + GROUND_CLEARANCE - low_off
...
if old in content:
    ...
    with open('runtime/debris_spawn.py', 'w') as f:
        f.write(content)
